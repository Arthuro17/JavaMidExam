...
public class Xiaomi extends Laptop {
    public Xiaomi(String Nama, String Prosesor, int Core, 
            String Os, int Ram, String Storage, int Stok){
        super(Nama, "Xiaomi", Prosesor, Core, Os, Ram, Storage, Stok);
    }
    
    public Xiaomi(){
        super();
        super.setBrand("Xiaomi");
    }
    
    public void xiaomiSlogan(){
        System.out.println("");
        System.out.println("=======================");
        System.out.println("Xiaomi");
        System.out.println("Xiaomi. Purely You.");
        System.out.println("=======================");
